    ...
    <div className="card w-96 bg-base-100 shadow-sm">
      <div className="card-body">
        <div className="text-right">
            ...
            <span className={`badge badge-xs ${product.tag === "popular" ? "bg-linear-to-r from-[#4F39F6] to-[#9514FA]" : product.tag === "new" ? "bg-[#0A883E] text-white" :  "badge-warning"} p-3 rounded-2xl`}>{product.tag}</span>
        </div>
        ...
        <button className="btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] rounded-3xl mt-4 text-white">Buy Now</button>
      </div>
    </div>
  );
};
